...
class MyListener(StreamListener):
    ...
    def __init__(self, output_dir, fileSizeLimit=250000000, logfile='logfile.txt', startCount=1):
        ...
        if len(os.listdir(self.myPath)) == 0:
            ...
            self.outJson = "tweet" + str(self.fileCount - 1) + ".json"
...
def download_tweets(consumer_key, consumer_secret, access_token, access_token_secret,
                    ...
                    track=None, fileSizeLimit=250000000, logfile='logfile.txt'):
    ...
    Keyword Arguments:
        ...
        track {list of str} -- a list of keywords to search. Set to None if no specified keywords are given. (default: {None})
        fileSizeLimit {int} -- the estimated size of each output .json file (default: {250000000})
